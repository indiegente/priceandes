...
.directive('ghanozCountries', ['$location', 'CountryList',
  ...
  function ghanozCountriesDirective($location, CountryList,
    ...
    var RELATIVE_TEMPLATE_PATH = 'views/typeahead-countries.tpl.html';
    var relativePath = RELATIVE_TEMPLATE_PATH;
    ...
    return {
      ...
      link: function postLinkFn(scope) {
        ...
        scope.$watch('pais', function(newValue) {
          // only emit if the pais is in the country list
          if (CountryListWithoutCode.indexOf(newValue) !== -1) {
